...
const EducationSection = () => {
    ...
    return (
        ...
        >
            ...
            {/* Content Container */}
            <div className={`relative pl-2 pr-6 sm:pl-4 sm:pr-8 md:pl-8 md:pr-16 lg:pl-16 lg:pr-28 pb-2 xs:pb-3 sm:pb-6 md:pb-8 lg:pb-10 transition-colors duration-300 ${
                    ...
                    {Array.isArray(EDUCATION) && EDUCATION.map((edu, index) => (
                        ...
                        >
                            ...
                            <motion.div 
                                ...
                                transition={{ duration: 0.4, delay: 1.3 + (index * 0.15), type: "spring", stiffness: 300 }}
                            >
                                ...
                                >
                                    <div className='flex items-start gap-2 xs:gap-3 sm:gap-4 md:gap-6 mb-2 xs:mb-3 sm:mb-4 md:mb-6'>
                                        ...
                                        <div className='min-w-0 flex-1'>
                                            <h3 className={`text-sm xs:text-base sm:text-lg md:text-xl lg:text-2xl font-bold mb-0.5 xs:mb-1 sm:mb-2 break-words group-hover:text-blue-400 transition-colors ${
                                    ...
                                    <div className='space-y-1.5 xs:space-y-2 sm:space-y-3 md:space-y-4'>
                                        ...
                                        <p className={`text-[10px] xs:text-xs sm:text-sm md:text-base leading-relaxed group-hover:text-gray-200 transition-colors ${
